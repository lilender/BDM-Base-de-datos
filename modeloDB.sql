...
CREATE TABLE GENEROS (
    ID_genero   BIT(3) UNSIGNED PRIMARY KEY AUTO_INCREMENT,
    genero      VARCHAR(20) NOT NULL
);
CREATE TABLE USUARIOS (
    ID_usuario          INT UNSIGNED PRIMARY KEY AUTO_INCREMENT,
    ID_genero           BIT(3) UNSIGNED NOT NULL,
...
CREATE TABLE CURSOS (
    ...
    promedio_calificacion DECIMAL(1,2) UNSIGNED DEFAULT NULL,
    estatus             BOOLEAN DEFAULT 1, -- 1 = activo, 0 = inactivo
...
CREATE TABLE COMENTARIOS (
    ...
    calificacion        BIT(3) UNSIGNED NOT NULL,
...
CREATE TABLE ESTUDIANTES_CURSOS (
    ...
    progreso            DECIMAL(3,2) UNSIGNED DEFAULT 0,
